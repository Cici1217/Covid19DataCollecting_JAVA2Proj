...
public class OneData {
    ...
    public String getDate_reported() {
        return Date_reported.get();
    }

    public SimpleStringProperty date_reportedProperty() {
    ...
    //
    private ArrayList<String> Day_case=new ArrayList<>();////绑定的日期，假设它存在，实际上可能不建在这里

    private ArrayList<Integer> Day_death=new ArrayList<>();
    ...
    public ArrayList<String> getDay_case() {
        return Day_case;
    }

    public void setDay_case(ArrayList<String> day_case) {
        Day_case = day_case;
    }

    public ArrayList<Integer> getDay_death() {
        return Day_death;
    }

    public void setDay_death(ArrayList<Integer> day_death) {
        Day_death = day_death;
    }
